...
with_node \
  ...
  --target "/Users/v/Documents/DealAnalyzer-fresh/mobile/ios/Pods/Target Support Files/Pods-TheComfortFinder/ExpoModulesProvider.swift" \
  --entitlement "/Users/v/Documents/DealAnalyzer-fresh/mobile/ios/TheComfortFinder/TheComfortFinder.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-document-picker" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-secure-store" "expo-web-browser"

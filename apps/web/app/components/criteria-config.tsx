...
import { configurableCriteriaSchema, type ConfigurableCriteria, type CriteriaResponse } from "@dealanalyzer/types";
            ...
            <h3 className="text-lg font-semibold text-card-foreground flex items-center gap-2">
              ...
              <InfoTooltip
                ...
                content={[
                  ...
                  "• COC Return: Target Cash-on-Cash return percentage (annual return on cash investment). Higher is better for passive income.",
                  "• Cap Rate: Target Capitalization rate percentage (NOI / property value). Indicates the property's potential return.",

...
export const apiLimit = pLimit(5); // Max 5 concurrent API calls
export const analysisLimit = pLimit(10); // Max 10 concurrent analyses
export const heavyLimit = pLimit(2); // Max 2 heavy operations (PDF parsing, AI analysis)

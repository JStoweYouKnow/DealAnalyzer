...
export const createAnalysis = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // }
        const analysisId = await ctx.db.insert("dealAnalyses", Object.assign(Object.assign({}, args), { userId, analysisDate: Date.now() }));
        return analysisId;
    },
});
...
export const createPhotoAnalysis = mutation({
    ...
    handler: async (ctx, args) => {
        const photoAnalysisId = await ctx.db.insert("photoAnalyses", Object.assign(Object.assign({}, args), { analysisDate: Date.now() }));

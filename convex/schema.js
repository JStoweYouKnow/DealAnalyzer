...
export default defineSchema({
    ...
    emailDeals: defineTable({
        ...
        status: v.union(v.literal("new"), v.literal("reviewed"), v.literal("analyzed"), v.literal("archived"), v.literal("pending"), v.literal("interested"), v.literal("not_interested")),
        ...
        extractedProperty: v.optional(v.object({
            ...
            sourceLinks: v.optional(v.array(v.object({
                url: v.string(),
                type: v.union(v.literal("listing"), v.literal("company"), v.literal("external"), v.literal("other")),
                description: v.optional(v.string()),
                aiScore: v.optional(v.number()),
                aiCategory: v.optional(v.union(v.literal("excellent"), v.literal("good"), v.literal("fair"), v.literal("poor"))),
    ...
    dealAnalyses: defineTable({
        ...
        property: v.object({
            ...
            propertyType: v.optional(v.union(v.literal("single-family"), v.literal("multi-family"), v.literal("condo"), v.literal("townhouse"), v.literal("duplex"), v.literal("commercial"))),
            // STR metrics
        ...
        criteria: v.object({
            strategy: v.union(v.literal("conservative"), v.literal("moderate"), v.literal("aggressive"), v.literal("brrrr")),
        ...
        aiAnalysis: v.optional(v.object({
            ...
            recommendedAction: v.union(v.literal("buy"), v.literal("pass"), v.literal("investigate")),
    ...
    neighborhoodTrends: defineTable({
        ...
        rentYield: v.number(),
        marketHeat: v.union(v.literal("hot"), v.literal("warm"), v.literal("balanced"), v.literal("cool")),
    ...
    marketHeatMapData: defineTable({
        ...
        latitude: v.number(),
        longitude: v.number(),
        heatLevel: v.union(v.literal("very_hot"), v.literal("hot"), v.literal("warm"), v.literal("balanced"), v.literal("cool")),
        averagePrice: v.number(),
    ...
    subscriptions: defineTable({
        ...
        status: v.union(v.literal("active"), v.literal("canceled"), v.literal("past_due"), v.literal("trialing"), v.literal("incomplete"), v.literal("incomplete_expired"), v.literal("unpaid")),
